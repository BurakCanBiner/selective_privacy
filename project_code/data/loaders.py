...
from .dataset_utils import FairFace, CelebA, Cifar10, LFW, UTKFace
from .dataset_utils import Challenge
...
class DataLoader():
    ...
    def setup_data_pipeline(self):
        ...
        if self.config["dataset"] == "fairface":
            ...
            train_config["format"] = "jpg"
            test_config["format"] = "jpg"
            train_dataset = UTKFace(train_config)
            test_dataset = UTKFace(test_config)
